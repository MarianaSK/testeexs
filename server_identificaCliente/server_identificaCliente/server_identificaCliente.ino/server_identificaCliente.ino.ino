...
void medirTemperaturaUmidade() {
  ...
  /*for(int i=0; i<19; i++){
    for(int j=0; j<2; j++){
    tabelaCliente[i][0]=serverMAC;
    //Serial.println(tabelaCliente[i]);
    tabelaCliente[i][1]=temperatura;
    Serial.println(tabelaCliente[i][j]);
    }
  }*/
  //delay(5000);
  //tomada_decisao_manual();
...
//====================================================================================
 ...
 // ESTRUTURA DE DADOS
  void tabelaCliente(){
    ...
    if (cliente=="B4:E6:2D:45:72:1E"){
      poscliente[2][0]=cliente;
      cliente2=cliente;
    }
    
     /* poscliente[0]=serverMAC;
      poscliente[1]=cliente1;
